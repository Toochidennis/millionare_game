...
class Particles2 {
    Particles2(Context context, RelativeLayout rootview, int imagexml,int size) {
    ...
    Particles2(Context context, LinearLayout rootview, int imagexml, int size) {
        for (int a = 0; a < size; a++) {
            new Particle(context, rootview, imagexml);
        }
    }
    ...
    class Particle {
        ...
        public void randomizePosition(Context context){
