...
//                        //  saveAnonymouseUser();
//                        text = readRawTextFile(R.raw.exam_json7);
//                        parseJSON(text);
//                    }else{
...
//                String levels = String.valueOf(question.getString(2));
//                String k = levels;
//                String key = levels;
//                String each_level_key = levels;
//
...
//                    obj.put("text", jsonArray.getString(j));
//                    answers.put(obj);
//
//                }
//
...
//
//
//                dbHelper.insertDetails(k,key,id,content,type,answer,correct,levels,each_level_key, reason);
//            }
//
//
//
